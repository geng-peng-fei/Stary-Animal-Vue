      ...
      <div class="friend-list">
        <ul>
          <li class="friend-item">
            ...
            <div class="friend-info"><img width="36"
                   height="36"
          ...
          <li class="friend-item">
            ...
            <div class="friend-info active"><img width="36"
                   height="36"
                   src="/images/face/face3.webp"
                   class="avatar">
